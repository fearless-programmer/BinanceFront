...
const menu = ref();
const userFullName = ref('John Doe'); // Placeholder - replace with actual user data
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <Button outlined icon="pi pi-user" label="Profile" raised @click="toggle" aria-haspopup="true" aria-controls="overlay_menu" />
